...
/**
 * Created by lwp940118 on 2016/10/27.
 */
...
public class CircleBroodLoadingRenderer extends LoadingRenderer {
    ...
    private final int DEFAULT_OVAL_COLOR = Color.parseColor("#FF673AB7");
    private final int DEFAULT_OVAL_DEEP_COLOR = Color.parseColor("#FF673AB7");
    private final int DEFAULT_BACKGROUND_COLOR = Color.parseColor("#FFE2B552");
